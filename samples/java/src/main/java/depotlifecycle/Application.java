...
@OpenAPIDefinition(
    ...
    tags = {
        ...
        @Tag(name="m_insurance_coverage", description="<SchemaDefinition schemaRef=\"#/components/schemas/InsuranceCoverage\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="InsuranceCoverage")})}),
        @Tag(name="m_party", description="<SchemaDefinition schemaRef=\"#/components/schemas/Party\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="Party")})}),
        ...
        @Tag(name="m_redelivery", description="<SchemaDefinition schemaRef=\"#/components/schemas/Redelivery\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="Redelivery")})}),
        @Tag(name="m_redelivery_detail", description="<SchemaDefinition schemaRef=\"#/components/schemas/RedeliveryDetail\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="RedeliveryDetail")})}),
        @Tag(name="m_redelivery_unit", description="<SchemaDefinition schemaRef=\"#/components/schemas/RedeliveryUnit\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="RedeliveryUnit")})}),
        @Tag(name="m_release", description="<SchemaDefinition schemaRef=\"#/components/schemas/Release\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="Release")})}),
        ...
        @Tag(name="m_release_detail_criteria", description="<SchemaDefinition schemaRef=\"#/components/schemas/ReleaseDetailCriteria\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="ReleaseDetailCriteria")})}),
        @Tag(name="m_release_unit", description="<SchemaDefinition schemaRef=\"#/components/schemas/ReleaseUnit\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="ReleaseUnit")})}),
        @Tag(name="m_gate_create", description="<SchemaDefinition schemaRef=\"#/components/schemas/GateCreateRequest\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="GateCreateRequest")})}),
        @Tag(name="m_gate_create_photo", description="<SchemaDefinition schemaRef=\"#/components/schemas/GateCreatePhoto\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="GateCreatePhoto")})}),
        ...
        @Tag(name="m_gate_status", description="<SchemaDefinition schemaRef=\"#/components/schemas/GateStatus\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="GateStatus")})}),
        @Tag(name="m_gate_update_request", description="<SchemaDefinition schemaRef=\"#/components/schemas/GateUpdateRequest\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="GateUpdateRequest")})}),
        @Tag(name="m_gate_update_photo", description="<SchemaDefinition schemaRef=\"#/components/schemas/GateUpdatePhoto\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="GateUpdatePhoto")})}),
        @Tag(name="m_estimate", description="<SchemaDefinition schemaRef=\"#/components/schemas/Estimate\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="Estimate")})}),
        @Tag(name="m_estimate_photo", description="<SchemaDefinition schemaRef=\"#/components/schemas/EstimatePhoto\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="EstimatePhoto")})}),
        @Tag(name="m_estimate_line_item", description="<SchemaDefinition schemaRef=\"#/components/schemas/EstimateLineItem\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="EstimateLineItem")})}),
        @Tag(name="m_estimate_line_item_part", description="<SchemaDefinition schemaRef=\"#/components/schemas/EstimateLineItemPart\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="EstimateLineItemPart")})}),
        @Tag(name="m_estimate_line_item_photo", description="<SchemaDefinition schemaRef=\"#/components/schemas/EstimateLineItemPhoto\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="EstimateLineItemPhoto")})}),
        ...
        @Tag(name="m_estimate_customer_approval", description="<SchemaDefinition schemaRef=\"#/components/schemas/EstimateCustomerApproval\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="EstimateCustomerApproval")})}),
        @Tag(name="m_work_order", description="<SchemaDefinition schemaRef=\"#/components/schemas/WorkOrder\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="WorkOrder")})}),
        @Tag(name="m_work_order_unit", description="<SchemaDefinition schemaRef=\"#/components/schemas/WorkOrderUnit\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="WorkOrderUnit")})}),
        @Tag(name="m_repair_complete", description="<SchemaDefinition schemaRef=\"#/components/schemas/RepairComplete\" />", extensions = { @Extension(properties = {@ExtensionProperty(name = "x-displayName", value="RepairComplete")})})
    },
    extensions = {
